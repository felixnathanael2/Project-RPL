...
router.get("/manajemen-pengguna", pageController.manajemenPengguna);

// Route Reset Password
router.get("/api/users", userController.getUsers);
router.put("/api/users/:id/reset-password", userController.adminResetPassword);

// Route Halaman Admin
router.get("/log-admin", pageController.logAdmin);
router.get("/riwayat-admin", pageController.riwayatAdmin);
