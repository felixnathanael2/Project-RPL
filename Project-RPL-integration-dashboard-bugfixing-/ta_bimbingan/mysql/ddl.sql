...
CREATE TABLE bimbingan (
    ...
    id_lokasi INT NULL, 
    tanggal DATE NOT NULL, -- Cukup satu baris ini
    waktu TIME NOT NULL,
...
CREATE TABLE bimbingan_dosen (
    ...
    status ENUM('Menunggu','Disetujui','Selesai','Ditolak') DEFAULT 'Menunggu', -- Ambil baris ini agar dosen bisa accept/reject
